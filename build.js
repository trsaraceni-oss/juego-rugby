...
const SCRIPTS = ['js/config.js', 'js/cloud.js', 'js/geom.js', 'js/model.js', 'js/field.js', 'js/render.js', 'js/mp4.js', 'js/video.js', 'js/input.js', 'js/ui.js', 'js/home.js', 'js/app.js'];
